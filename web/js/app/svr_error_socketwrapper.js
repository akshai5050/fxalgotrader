define(["c"], function(c) {
    ...
    function SvrErrorSocketWrapper(socket, tf, series_profit) {
        if (!(this instanceof SvrErrorSocketWrapper)) {
    ...
    SvrErrorSocketWrapper.prototype = {
