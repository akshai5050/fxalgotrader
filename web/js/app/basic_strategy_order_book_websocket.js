define(["c"], function(c) {
    ...
    function BasicOrderBookSocketWrapper(socket, tf) {
        if (!(this instanceof BasicOrderBookSocketWrapper)) {
    ...
    BasicOrderBookSocketWrapper.prototype = {
    ...
    return BasicOrderBookSocketWrapper;
