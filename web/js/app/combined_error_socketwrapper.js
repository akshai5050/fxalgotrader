define(["c"], function(c) {
    ...
    function CombinedErrorSocketWrapper(socket, tf, series_profit) {
        if (!(this instanceof CombinedErrorSocketWrapper)) {
    ...
    CombinedErrorSocketWrapper.prototype = {
    ...
    return CombinedErrorSocketWrapper;
