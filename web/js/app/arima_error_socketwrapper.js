define(["c"], function(c) {
    ...
    function ArimaErrorSocketWrapper(socket, tf, series_profit) {
        if (!(this instanceof ArimaErrorSocketWrapper)) {
    ...
    ArimaErrorSocketWrapper.prototype = {
    ...
    return ArimaErrorSocketWrapper;
