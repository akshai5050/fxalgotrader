define(["c"], function(c) {
    ...
    function CombinedSocketWrapper(socket, tf, series_actual, series_prediction) {
        if (!(this instanceof CombinedSocketWrapper)) {
    ...
    CombinedSocketWrapper.prototype = {
